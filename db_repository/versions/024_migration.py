...
def upgrade(migrate_engine):
    ...
    pre_meta.tables['sentences'].columns['inputdate'].drop()
    post_meta.tables['sentences'].columns['timestamp'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    pre_meta.tables['sentences'].columns['inputdate'].create()
    post_meta.tables['sentences'].columns['timestamp'].drop()
