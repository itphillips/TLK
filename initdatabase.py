...
cur = conn.cursor()
cur.execute("CREATE TABLE sentences (id serial PRIMARY KEY, username varchar, password varchar, sessionID varchar, language varchar, collection_date date, sessionnumber int, notes varchar, collection_location varchar, sentence_type varchar, sentence varchar, eng_gloss varchar, correctness varchar );")
